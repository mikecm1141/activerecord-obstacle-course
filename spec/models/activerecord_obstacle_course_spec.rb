...
describe 'ActiveRecord Obstacle Course' do
  ...
  it "13. groups an order's items by name" do
    ...
    # ------------------ Using ActiveRecord ----------------------
    grouped_items = Item.joins(:orders).where("orders.id = ?", 3)
    # ------------------------------------------------------------
  ...
  it '16. returns the names of users who ordered one specific item' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    users = User.select(:name).distinct.joins(:orders).joins(:items).where("order_items.item_id = ?", item_8.id).order("users.name").pluck(:name)
    # ------------------------------------------------------------
  ...
  it '17. returns the name of items associated with a specific order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    names = Order.joins(:items).pluck(:name).last(4)
    # ------------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:items).where(user_id: 2).where("item_id = ?", 4)
    # -----------------------------------------------------------
  ...
  it '27. returns a table of information for all users orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    custom_results = User.joins("JOIN orders ON users.id=orders.user_id")
  ...
  it '28. returns a table of information for all users items' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    custom_results = User.joins("JOIN orders ON users.id=orders.user_id JOIN order_items ON orders.id=order_items.order_id")
  ...
  it '29. returns a table of information for all users orders and item counts' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    data = User.joins("JOIN orders ON users.id=orders.user_id JOIN order_items ON order_items.order_id=orders.id")
